...
define(
    ...
    function (
        ...
        var paymentConfig = (window.checkoutConfig && window.checkoutConfig.payment) ? window.checkoutConfig.payment : {};
        var checkoutConfig = paymentConfig.mollie || {};

        checkoutConfig.creditcard = checkoutConfig.creditcard || {};
        checkoutConfig.applepay = checkoutConfig.applepay || {};
